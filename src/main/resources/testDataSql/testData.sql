...
delete from board;
delete from user;
insert into user values ('1', 'sungjin', 'hong', 'sungjin@naver.com', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1epersonProject', '/img/user/default.png', 'Y', 'N', '2016-2-2', '2016-2-2');
insert into user values ('2', 'sungjine', 'sungjine', 'sungjine@naver.com', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1epersonProject', '/img/user/default.png', 'N', 'N', '2016-2-2', '2016-2-2');
insert into user values ('3', 'admin', 'admin', 'admin@naver.com', '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1epersonProject', '/img/user/default.png', 'Y', 'Y', '2016-2-2', '2016-2-2');
